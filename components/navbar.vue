...
<template>
  <Disclosure as="nav" class="bg-gradient-to-r from-sky-900 to-indigo-700 sticky top-0" v-slot="{ open }">
          ...
          <Menu as="div" class="relative ml-3">
            ...
            <transition enter-active-class="transition ease-out duration-100"
              ...
              <MenuItems
                ...
                <a href="https://www.facebook.com/fahmidhasan.konok/"
                  :class="[active ? 'bg-gray-100' : '', 'block px-4 py-2 text-sm text-gray-700']"
                  target="_blank">facebook</a>
                </MenuItem>
                <MenuItem v-slot="{ active }">
                <a href="https://twitter.com/hasankonok37"
                  :class="[active ? 'bg-gray-100' : '', 'block px-4 py-2 text-sm text-gray-700']"
                  target="_blank">twitter</a>
                </MenuItem>
                <MenuItem v-slot="{ active }">
                <a href="https://github.com/3725fahmid"
                  :class="[active ? 'bg-gray-100' : '', 'block px-4 py-2 text-sm text-gray-700']"
